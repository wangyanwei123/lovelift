...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    HomeDetallViewController * homede = [[HomeDetallViewController alloc]init];
    
    HomeModel * model = self.dataArray[indexPath.row];

    homede.dataID = model.dataID;
    
    homede.hidesBottomBarWhenPushed = YES;
    
    [self.navigationController pushViewController:homede animated:YES];
